...
#include "plugin/transformations/dynamic_scale_convolution.hpp"
...
void TransformationsPipeline::apply(std::shared_ptr<ov::Model> func) {
...

    {
        ...
        // if (config.get_property(ov::intel_gpu::hint::enable_dynamic_scale)) {
            manager.register_pass<ov::intel_gpu::DynamicScaleConvolution>();
